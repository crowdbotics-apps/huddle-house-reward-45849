"""
Django settings for huddle_house_reward_45849 project.
...
ROOT_URLCONF = 'huddle_house_reward_45849.urls'
...
WSGI_APPLICATION = 'huddle_house_reward_45849.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "huddle_house_reward_45849 API",
    "DESCRIPTION": "API documentation for huddle_house_reward_45849 App",
    "VERSION": "v1",
}
